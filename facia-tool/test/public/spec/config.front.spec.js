...
describe('Config Front', function () {
    beforeEach(function () {
        ...
        vars.CONST.searchDebounceMs = 10;
    ...
    it('create fronts and collections', function (done) {
        ...
        function createFrontAndCollection () {
            ...
            expect(frontWidget.fronts().length).toBe(1);
            var front = frontWidget.fronts()[0];
        ...
        function modifyCollectionWithInvalidCAPI () {
            ...
            return wait.ms(vars.CONST.searchDebounceMs + 60).then(() => {
